...
import { ReactComponent as NuevoCup } from "assets/icons/nuevo-cup.svg";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.banner} style={{ backgroundImage: `url(${background})` }}>
        <NuevoCup className={styles.nuevoCup} />
      </div>
      <div className={styles.content}>
        <div className={styles.texts}>
          <Typography variant="h1">Nuevo palace typer</Typography>
          <Typography variant="h3">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, quia soluta. Dolore ducimus ipsam libero non
            provident rerum totam vero!
          </Typography>
        </div>
